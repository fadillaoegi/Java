...
public class Quiz2_Praktikum_PD {
                        ...
                        switch(pilihan_menu_2) {
                            ...
                            case 2:
                                ...
                                for (int i = 0; i < kuliah.length; i++) {
                                    ...
                                    if (kuliah[i][1].toLowerCase().contains(nama_mk.toLowerCase())) {
                                        ...
                                        System.out.println(kuliah[i][0] + " " + kuliah[i][1] + " " + kuliah[i][3]);
                                    }
                                }
                                if (ditemukan==0) {
                            ...
                            case 3 :
                                ...
                                for (int i = 0; i < kuliah.length; i++) {
                                    ...
                                    int g = Integer.parseInt (kuliah[i][3]);
                                    
                                    if ( g >= x && y <= y ) {
                                        
                                        System.out.println(kuliah[i][0] + " " + kuliah[i][1] + " " + kuliah[i][2] + " " + kuliah[i][3] + " " );
